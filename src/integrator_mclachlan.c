 ...
 * O(epsilon t^3). For more details see McLauchlan (2003). 
 * 
 * @section 	LICENSE
...
const double 	integrator_substep_collisions_dt1[5] = {0.,0.,0.577350269189626,0.,0.211324865405187};
const double 	integrator_substep_collisions_dt2[5] = {0.,0.,0.,0.,0.211324865405187};
