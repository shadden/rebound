...
void problem_init(int argc, char* argv[]){
	...
	// Setup homog. sphere
	tmax		=2.*M_PI;
	dt		= 2.78326487623487623487*M_PI/input_get_double(argc,argv,"timesteps",1000);
...
extern unsigned long integrator_iterations_max_exceeded;
void problem_finish(){
	...
	fprintf(of,"%lu\t",integrator_iterations_max_exceeded);
	fprintf(of,"\n");
	fclose(of);
}
double outputnum=0;
